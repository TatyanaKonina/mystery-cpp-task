...
## **Main idea**
В задаче производится распаралеливание подсчетов новых координат точек и их в отпределенный момент времени.
...
Использование мьютексов для синхронизации потоков и переменных условия отнимает для подсчетов немного времени. Как видно из графиков - оптимальное кол-во потоков для каждого эксперимента было 16. В зависимости от кол-ва итераций - время либо увеличивалось, либо уменьшалось.
